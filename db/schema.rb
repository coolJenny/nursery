...
ActiveRecord::Schema.define(version: 20180102110412) do
  ...
  add_index "child_collaborators", ["child_id"], name: "index_child_collaborators_on_child_id"
  ...
  add_index "discussion_participants", ["discussion_id"], name: "index_discussion_participants_on_discussion_id"
  ...
  add_index "discussions", ["subject_type", "subject_id"], name: "index_discussions_on_subject_type_and_subject_id"
  ...
  add_index "health_record_components", ["health_record_id"], name: "index_health_record_components_on_health_record_id"
  ...
  add_index "message_subjects", ["parent_subject_id"], name: "index_message_subjects_on_parent_subject_id"
  ...
  add_index "message_templates", ["sub_subject_id"], name: "index_message_templates_on_sub_subject_id"
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
    t.string   "target_roles",        default: "--- []\n"
  end

  add_index "messages", ["message_template_id"], name: "index_messages_on_message_template_id"
  ...
  add_index "user_affiliates", ["affiliate_id"], name: "index_user_affiliates_on_affiliate_id"
  add_index "user_affiliates", ["user_id"], name: "index_user_affiliates_on_user_id"
  ...
  add_index "votes", ["vote_candidate_code"], name: "index_votes_on_vote_candidate_code"
